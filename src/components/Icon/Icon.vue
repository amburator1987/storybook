<template>
  ...
  >
    ...
    <!-- Info (24) — Figma reference glyph (8026:524), exact vector path -->
    <svg
      v-else-if="name === 'info'"
      :class="$style['kzn-c-icon__svg']"
      viewBox="0 0 24 24"
...
export type IconName = "chevron-down" | "chevron-up" | "chevron-left" | "chevron-right" | "document" | "activity" | "close" | "info";
